//! Shared error types for the Lumys OS system.

use thiserror::Error;

/// Top-level error type for the Lumys OS system.
#[derive(Error, Debug)]
pub enum LumysError {
...
/// Alias for Result with LumysError.
pub type LumysResult<T> = Result<T, LumysError>;
