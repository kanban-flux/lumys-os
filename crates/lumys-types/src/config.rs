//! Configuration types for the Lumys OS kernel.
...
impl Default for WebhookTriggerConfig {
    fn default() -> Self {
        Self {
            enabled: false,
            token_env: "LUMYS_WEBHOOK_TOKEN".to_string(),
...
pub struct DockerSandboxConfig {
    ...
    pub image: String,
    /// Container name prefix. Default: "lumys-sandbox".
...
impl Default for DockerSandboxConfig {
    fn default() -> Self {
        Self {
            ...
            container_prefix: "lumys-sandbox".to_string(),
...
pub struct VaultConfig {
    ...
    pub enabled: bool,
    /// Custom vault file path (default: ~/.lumys/vault.enc).
...
pub struct KernelConfig {
    /// Lumys OS home directory (default: ~/.lumys).
    pub home_dir: PathBuf,
    /// Data directory for databases (default: ~/.lumys/data).
    ...
    /// Root directory for agent workspaces. Default: `~/.lumys/workspaces`
    #[serde(default)]
    ...
    /// Defaults to `~/.lumys/workflows`. Set to empty string to disable.
    #[serde(default)]
...
pub struct AuthConfig {
    ...
    /// Generate with: lumys auth hash-password
...
/// Resolve the Lumys OS home directory.
///
/// Priority: `LUMYS_HOME` env var > `~/.lumys`.
fn lumys_home_dir() -> PathBuf {
...
pub struct MatrixConfig {
    ...
    /// Bot user ID (e.g., "@lumys:matrix.org").
    pub user_id: String,
...
pub struct IrcConfig {
    ...
    /// Channels to join (e.g., `["#lumys", "#general"]`).
    #[serde(default, deserialize_with = "deserialize_string_or_int_vec")]
...
mod tests {
    ...
    fn test_validate_missing_env_vars() {
        ...
        config.channels.discord = Some(DiscordConfig {
            bot_token_env: "LUMYS_TEST_NONEXISTENT_VAR_DC".to_string(),
            ..Default::default()
        });
        let warnings = config.validate();
