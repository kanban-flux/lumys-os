// Lumys OS Visual Workflow Builder — Drag-and-drop workflow designer
'use strict';
...
function workflowBuilder() {
  return {
    ...
    async init() {
      ...
      try {
        var list = await Lumys OSAPI.get('/api/agents');
    ...
    async saveWorkflow() {
      ...
      try {
        await Lumys OSAPI.post('/api/workflows', {
          name: this.workflowName || 'untitled',
          description: this.workflowDescription || '',
          steps: steps
        });
        Lumys OSToast.success('Workflow saved!');
