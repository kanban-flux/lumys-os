...
If you discover a security vulnerability in Lumys OS, please report it responsibly.

**Do NOT open a public GitHub issue for security vulnerabilities.**

### How to Report

1. Email: **jaber@lumys.sh**
2. Include:
...
Lumys OS implements defense-in-depth with the following security controls:
