//! Color palette matching the Lumys OS landing page design system.
//!
...
pub const ACCENT: Color = Color::Rgb(67, 39, 118); // #432776 — Lumys OS violet
pub const ACCENT_DIM: Color = Color::Rgb(90, 55, 150); // #5A3796 — lighter violet
