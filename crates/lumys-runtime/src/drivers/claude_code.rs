...
use dashmap::DashMap;
use lumys_types::message::{ContentBlock, Role, StopReason, TokenUsage};
        ...
        if skip_permissions {
            warn!(
                "Claude Code driver: --dangerously-skip-permissions enabled. \
                 ...
                 Lumys OS's own capability/RBAC system enforces access control."
            );
        }
...
mod tests {
    ...
    fn test_build_prompt_simple() {
        use lumys_types::message::{Message, MessageContent};
