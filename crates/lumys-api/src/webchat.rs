...
const ETAG: &str = concat!("\"lumys-", env!("CARGO_PKG_VERSION"), "\"");
...
/// GET /logo.png — Serve the Lumys OS logo.
...
/// GET /favicon.ico — Serve the Lumys OS favicon.
...
/// GET / — Serve the Lumys OS Dashboard single-page application.
///
...
/// The embedded HTML/CSS/JS for the Lumys OS Dashboard.
///
