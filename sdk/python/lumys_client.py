"""
Lumys OS Python Client — REST API client for controlling Lumys OS remotely.

Usage:

    from lumys_client import Lumys OS

    client = Lumys OS("http://localhost:3000")
...
Note: This is the REST API *client* library.
      For writing Python agents that run inside Lumys OS, see lumys_sdk.py instead.
"""
...
class _Resource:
    def __init__(self, client: "Lumys OS"):
        self._c = client


class Lumys OS:
    """Lumys OS REST API client. Zero dependencies — uses only stdlib urllib."""
    ...
    def _request(self, method: str, path: str, body: Any = None) -> Any:
        ...
        try:
            ...
            raise Lumys OSError(f"HTTP {e.code}: {body_text}", e.code, body_text) from e
