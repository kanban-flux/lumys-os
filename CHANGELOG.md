...
All notable changes to Lumys OS will be documented in this file.
...
#### Client SDKs
- JavaScript SDK (`@lumys/sdk`): full REST API client with streaming, TypeScript declarations
- Python client SDK (`lumys_client`): zero-dependency stdlib client with SSE streaming
- Python agent SDK (`lumys_sdk`): decorator-based framework for writing Python agents
...
- MCP server (exposes Lumys OS tools via MCP protocol)
...
[0.1.0]: https://github.com/ENI-Ethereal-Nexus-Institute/lumys-os/releases/tag/v0.1.0
