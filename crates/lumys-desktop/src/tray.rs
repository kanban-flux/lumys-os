//! System tray setup for the Lumys OS desktop app.
...
pub fn setup_tray(app: &tauri::App) -> Result<(), Box<dyn std::error::Error>> {
    ...
    let quit = MenuItem::with_id(app, "quit", "Quit Lumys OS", true, None::<&str>)?;
                    ...
                    match crate::updater::check_for_update(&app_handle).await {
                        Ok(info) if info.available => {
                            ...
                            let _ = app_handle
                                ...
                                .body(format!(
                                    "Downloading Lumys OS v{version}. App will restart shortly."
                                ))
                                .show();
                            // Perform install
                            if let Err(e) =
                        ...
                        Ok(_) => {
                            let _ = app_handle
                                ...
                                .builder()
                                .title("Up to Date")
                                .body("You're running the latest version of Lumys OS.")
                                .show();
                        }
                        Err(e) => {
