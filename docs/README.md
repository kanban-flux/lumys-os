# Lumys OS Documentation

Welcome to the Lumys OS documentation. Lumys OS is the open-source Agent Operating System -- 14 Rust crates, 40 channels, 60 skills, 20 LLM providers, 76 API endpoints, and 16 security systems in a single binary.
...
| Path | Description |
|------|-------------|
| `~/.lumys/config.toml` | Main configuration file |
| `~/.lumys/data/lumys.db` | SQLite database |
| `~/.lumys/skills/` | Installed skills |
| `~/.lumys/daemon.json` | Daemon PID and port info |
